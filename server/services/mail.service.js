...
const signupMail = async (to, name) => {
  try {
    const message = {
      from: "petmanager08@gmail.com",
      to,
      subject: "Welcome to Pet Manager System",
      html: `
