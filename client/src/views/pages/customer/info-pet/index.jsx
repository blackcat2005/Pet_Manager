      ...
      <div className="pet-info__header">
        ...
        <div className="pet-info__header__title">
          ...
          <div className="pet-info__header__button-add-pet">
            <Button onClick={handleAddPet} type="primary" icon={<PlusOutlined />}>
              Thêm
            </Button>
          </div>
        </div>
