...
const InfoPet = () => {
  ...
  useEffect(() => {
    const fetchPetList = async () => {
      const res = await pet.getPetList()
      setPetList(res.data)
    }
    fetchPetList()
  }, [])
  ...
  >
    <div className='pet-info__header'>
      ...
      <div className='pet-info__header__title'>
        ...
        <div className='pet-info__header__button-add-pet'>
          <Button type='primary' ><PlusOutlined />Thêm</Button>
        </div>  
      </div>
    ...
    <div className='pet-info__card-list'>
      {petList === null ?
      <div className='pet-info__card-list__none'>Bạn dell có thú cưng!!!!</div>
      :
      petList.map((petinfo) => (
        <Card
        hoverable
