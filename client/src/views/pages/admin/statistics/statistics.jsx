...
import { Card, Col, Row, Statistic, DatePicker, Space, Input, Select, ConfigProvider, Typography, Spin } from 'antd';
...
const appoinmentFake = [
    ...
    { month: 'Tháng 6', count: '2', sum: 1000000 },
    { month: 'Tháng 7', count: '1', sum: 2000000 },
    { month: 'Tháng 8', count: '1', sum: 1500000 },
    { month: 'Tháng 9', count: '3', sum: 3000000 },
    { month: 'Tháng 10', count: '2', sum: 2500000 },
    { month: 'Tháng 11', count: '2', sum: 2500000 },
    { month: 'Tháng 12', count: '2', sum: 1000000 },
]
...
const beautyFake = [
    ...
    { month: 'Tháng 6', count: '2', sum: 500000 },
    { month: 'Tháng 7', count: '1', sum: 1000000 },
    { month: 'Tháng 8', count: '1', sum: 800000 },
    { month: 'Tháng 9', count: '3', sum: 1200000 },
    { month: 'Tháng 10', count: '2', sum: 1500000 },
    { month: 'Tháng 11', count: '2', sum: 1500000 },
    { month: 'Tháng 12', count: '2', sum: 500000 },
]
...
const storageFake = [
    ...
    { month: 'Tháng 6', count: '2', sum: 200000 },
    { month: 'Tháng 7', count: '1', sum: 300000 },
    { month: 'Tháng 8', count: '1', sum: 250000 },
    { month: 'Tháng 9', count: '3', sum: 500000 },
    { month: 'Tháng 10', count: '2', sum: 450000 },
    { month: 'Tháng 11', count: '2', sum: 450000 },
    { month: 'Tháng 12', count: '2', sum: 200000 },
]

const Statistics = () => {
    const [paymentCount, setPaymentCount] = useState(0);
    const [revenueAppointmentData, setRevenueAppointmentData] = useState(appoinmentFake);
    ...
    const valueFormatter = (value) => value.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + ' VNĐ';
    ...
    const chartSetting = {
        ...
        series: [{ dataKey: 'sum', label: 'Tổng doanh thu 1 tháng', valueFormatter }],
        height: 300,
        sx: {
    ...
    useEffect(() => {
        const getMonthlyRevenue = (data, month) => {
            const monthData = data.find(d => parseInt(d.month.split(' ')[1]) === month);
        ...
        if (monthNow > 1) {
            const changePercentage = calculatePercentageChange(currentMonthRevenue, previousMonthRevenue);
                ...
                </div>
                {
                    isLoading ?
                        ...
                        <div className='statistics__content'>
                            <div className='statistics__content__item' style={{ height: '340px' }}>
                                <Card
                                ...
                                >
                                    <PieChart
                                        series={[
                                            {
                                                data: [
                                                    { id: 0, value: `${useRate.appointment}`, label: 'Khám/Chữa bệnh' },
                                                    { id: 1, value: `${useRate.beauty}`, label: 'Vệ sinh/Làm đẹp' },
                                                    { id: 2, value: `${useRate.storage}`, label: 'Lưu trữ' },
                                                ],
                                            },
                                        ]}
                                        width={480}
                                ...
                                <div style={{ display: 'flex', gap: '10px', flexDirection: 'column', width: '40%' }}>
                                    ...
                                    <Card title={`Tổng doanh thu trong tháng ${monthNow}`} style={{ width: '100%' }}>
                                        <div className='data'>
                                        ...
                                        <div className='evaluate'>
                                            <Statistic
                                                ...
                                                precision={2}
                                                valueStyle={{ color: revenueChangePercentage > 0 ? '#3f8600' : '#cf1322' }}
                                                prefix={revenueChangePercentage > 0 ? <ArrowUpOutlined /> : <ArrowDownOutlined />}
                                                suffix="%"
                                            />
